...
class Calculator:
    def __init__(self, master):
        ...
        self.entry_value = ''
        Entry(width=17, bg='#1cddff', font=('Arial Bold', 28), textvariable=self.equation).place(x=0, y=0)
        ...
        Button(width=11, height=4, text='=', relief='flat', bg='lightblue', command=self.solve).place(x=270, y=200)
        
        # Set the "C" button to light ash
        Button(width=11, height=4, text='C', relief='flat', bg='#B2BEB5', command=self.clear).place(x=0, y=350)
